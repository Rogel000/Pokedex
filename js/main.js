document.addEventListener("DOMContentLoaded", () => {
    ...
    const myPokemonsDiv = document.getElementById("myPokemons"); // Ajout de cette ligne
    ...
    function displayPokemon(pokemonData) {
      ...
      pokemonInfoDiv.innerHTML = `
          ...
          <div class="types">
            <strong>Type:</strong>
            ${types.map((type) => `<span class="type">${type.type.name}</span>`).join("")}
          </div>
          <div class="abilities">
      ...
      // Ajout de l'écouteur d'événement sur l'image de Pokéball après l'affichage du Pokémon
